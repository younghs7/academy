(()=>{
    ...
    const setLayout = function()
    {
        ...
        {
            sectionSet[0].hMultiple = 7;
            sectionSet[1].hMultiple = 5;
        }
    ...
    const playAnimation = function()
    {
        ...
        {   
            ...
            case 0:
               ...
               if( (0.74 < scrollRate)  && (scrollRate < 0.96) )
                {   
    ...
    {   
        ...
        imageElement.addEventListener('load', ()=>{
            ...
            // 3. 캔버스에 0번 이미지를 드로잉한다.
            sectionSet[0].objs.canvas.getContext('2d').drawImage(canvasImages[0], 0, 0);

        });


   
        // const canvas = sectionSet[0].objs.canvas;
        // const gc = sectionSet[0].objs.context;
        // let canvasImages = sectionSet[0].objs.canvasImages;
