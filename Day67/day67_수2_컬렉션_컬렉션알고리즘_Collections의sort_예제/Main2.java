...
public class Main2 {
	...
	public static void main(String[] args) {
		...
		// 2. Comparable이 구현된 상위 클래스를 상속받거나, Comparable을 구현해야한다.
		// 3. T는 
		 
		 
		 
		// 아. <T extends Comparable<> > 이고
		// comparable은 comparable<? super T> 라는 거구나
		// 즉 T가 Integer라면,
		// Integer는 Comparable 인터페이스를 상속받아야 하고
		// Comparable<? super Integer> 라는 것. ==> Comparable<Number>를 상속받아도 허용한다는 것이다.
