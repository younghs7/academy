...
public class Main7 {
	...
	// 고객은 이름, 고객번호 (int, > 0 ), 아이디, 고객구분(일반0, VIP1)으로 이루어져 있다
	
	
	// - 고객 리스트를 만드세요. 
	// - 고객리스트를 고객 번호를 기준으로 오름차순하는 정렬하세요.
	// - 고객 리스트에서 고객 번호로 검색하는 기능을 만들어보세요.
	
	// - 옵션: VIP 고객인 경우 고객번호 기준으로 정렬 시 가장 앞쪽에 위치하게 정렬시키세요.
	...
	public static void main(String[] args)
	{
		...
		System.out.println(searchBy(cList, 1) );
