...
<body>
	...
	<section>
		<h1> 회원등록 </h1>
		<form method="post" action="DB_insert.jsp" id="form" target="iframe">
			<table border="1">
				<tr>
					<th>회원번호(자동발생)</th>
					<td><input id="custno" name="custno" readonly="readonly" value="<%= max %>" ></td>
				</tr>
	...
	(()=>{
		...
		,	{ref: joindate, 	size: 13,	sizeMsg: "가입일자가 유효한 글자수가 아닙니다.",	nodataMsg: "가입일자를 입력해야 합니다."}
