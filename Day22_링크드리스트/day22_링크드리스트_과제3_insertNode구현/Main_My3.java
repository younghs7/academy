package day22_링크드리스트_과제3_insertNode구현;

public class Main_My3 {
	...
	{	
		...
		{	
			...
			System.out.println(pointerNodeData.getIntValue());
			System.out.println(pointerNodeData.getStrValue());
		...
		if(pointerNode.getNext() == null)
		{
			pointerNodeData = pointerNode.getData();
			System.out.println(pointerNodeData.getIntValue() );
			System.out.println( (pointerNode.getData()) .getStrValue() );
